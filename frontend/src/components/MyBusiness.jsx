    ...
    <div className="flex flex-col gap-3">
      ...
      <div data-testid="stake-card" className="card-glow p-5">
        <div className="mb-2 flex items-center gap-2">
          <Layers size={16} className="text-[#4F8DFF]" />
        ...
        <button data-testid="stake-btn" onClick={() => soon("Staking")} className="w-full rounded-xl bg-gradient-to-r from-[#2F6BFF] to-[#4F8DFF] py-3 text-sm font-bold text-white active:scale-[0.98]">
          Stake
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div data-testid="mining-cap-card" className="card-glow p-4">
          <Pickaxe size={16} className="mb-2 text-[#4F8DFF]" />
        ...
        <div data-testid="mining-reward-card" className="card-glow p-4">
          ...
          <button data-testid="mine-btn" onClick={() => soon("Mining")} className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-[#2F6BFF]/20 py-2 text-xs font-semibold text-[#4F8DFF] active:scale-95">
      ...
      <div data-testid="holding-card" className="card-glow p-5">
        <div className="flex items-center justify-between">
          ...
          <button data-testid="sell-btn" onClick={() => soon("Selling")} className="flex items-center gap-1 rounded-xl bg-[#2F6BFF]/15 px-3 py-2 text-xs font-semibold text-[#4F8DFF] active:scale-95">
        ...
        <div className="mt-3 grid grid-cols-3 gap-2 text-center">
          ...
          <div><div className="text-[10px] text-white/40">Appreciation</div><div className="text-sm font-semibold text-[#4F8DFF]">+${usd(holding.appreciation_usdt)}</div></div>
        </div>
      </div>
